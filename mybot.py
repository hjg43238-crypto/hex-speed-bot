...
def check_image_format(image_data):
    try:
...
web_thread.start()
print("🌐 سيرفر الويب يعمل على المنفذ: 8080")

TOKEN = os.environ.get("TELEGRAM_TOKEN", "8375820223:AAENKlwxCbif4SDc4xSETcTjdum27ccfxWY")
